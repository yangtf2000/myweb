...
window.SECTIONS = [
  ...
  },
  {
    ...
    articles: [
      ...
      { slug: 'toolbox', title: '城市更新工具箱使用指南', date: '2026.08', tag: '手册', icon: 'policy', desc: '84 条政策工具 · 场景痛点 · 操作步骤 · 真实案例。', detail: '基于《湖南建设信息》2026年第65期《湖南省城市更新工具箱（2026年8月）》整理的实操手册：每条工具含使用场景与痛点、操作步骤建议、使用条件关键词标注、带具体数字的模拟案例，按项目阶段与政策板块双维筛选。' }
    ]
  },
  {
    id: 'ai',
  ...
  },
  {
    ...
    articles: [
      ...
      { slug: '牛来', title: '别笑，我们连牛来这部烂片都不如', date: '2026.08', tag: '公众号', icon: 'wechat', desc: '从《牛来》这部全网笑其烂的影片，照见我们自己那部拍了几十年还卡在“进行中”的人生。', detail: '《牛来》火了，因为全网都在笑它烂——一对母子手搓五年的片子。可笑完之后，文章转向我们自己：工作马马虎虎、日子得过且过，心里都藏着“等我准备好了就开始”，一等就是半辈子。我们笑别人烂，自己那部人生却连杀青都遥遥无期。' }
    ]
  }
];
