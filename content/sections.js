...
window.SECTIONS = [
  {
    ...
    articles: [
      {
        slug: '2026-08-24', title: '城建政策周报 · 第五期', date: '2026.08.24', tag: '周报', icon: 'policy',
        issue: '第五期',
        desc: '公积金条例正式落地（国令844号）+ 国常会清欠"连环清" + 岳阳城市更新资源发布（39片区/岳阳楼19.56亿/洞麻14亿）。',
        detail: '本期主线：李强8/18签署国务院令844号正式修改《住房公积金管理条例》（9/20施行，装修/物业费可提、灵活就业自愿缴存）；8/21国常会部署清理拖欠企业账款"连环清"、用好专项债与专项再贷款，财政部等三部门财金71号扩大财政金融协同促内需；岳阳本周深度聚焦——省住建厅"城市更新资源发布"岳阳篇登场，39个片区、72.25km²，岳阳楼片区19.56亿（社会资本20%）、洞麻厂14亿（社会资本65.39%）。',
        chart: { caption: '岳阳本周城市更新投资盘子（亿元）', bars: [
          { l: '岳阳楼片区', v: 19.56, u: '亿' }, { l: '洞麻厂', v: 14, u: '亿' },
          { l: '临湘城南地下管线', v: 2.25, u: '亿' }, { l: '已披露合计', v: 35.81, u: '亿' }
        ] }
      },
      {
